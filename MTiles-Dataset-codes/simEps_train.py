...
iter_per_epoch = 30 #Change this value accordingly based on the partition proportion of labeled and unlabeled samples
    ...
    def run(self):
        ...
        for epoch in range(1, epochs):
            ...
            for iteration in range (1, iter_per_epoch): #(zip(train_loader, unlabeled_train_loader)):
                ...
                # sim_loss_1 = 0.5*(sim_loss(x4_1, x4_2.detach()) + sim_loss(x4_1.detach(), x4_2))  
                # sim_loss_2 = 0.5*(sim_loss(x4_1_un, x4_2_un.detach()) + sim_loss(x4_1_un.detach(), x4_2_un))  
                # sim_loss_3 = 0.5*(sim_loss(f4_1, f4_2.detach()) + sim_loss(f4_1.detach(), f4_2))  
                # sim_loss_4 = 0.5*(sim_loss(f4_1_un, f4_2_un.detach()) + sim_loss(f4_1_un.detach(), f4_2_un))  
                # inp_sim_loss = sim_loss_1 + sim_loss_2
                # sim_loss_3 = sim_loss(out_1, out2) + sim_loss(out1, out_3) + sim_loss(out_1, out2) + sim_loss(out1, out_3)
                ...
                inp_sim_loss = sim_loss_12 + sim_loss_13 + sim_loss_23 + sim_loss_un_12 + sim_loss_un_13 + sim_loss_un_23
            ...
            if self.save_best_model_1:
                ...
                torch.save(state_1, Checkpoints_Path + '/simEps_40p_1.pth')
            ...
            if self.save_best_model_2:
                ...
                # state["best_loss"] = self.best_loss
                torch.save(state_2, Checkpoints_Path + '/simEps_40p_2.pth')
            ...
            if self.save_best_model_3:
                ...
                # state["best_loss"] = self.best_loss
                torch.save(state_3, Checkpoints_Path + '/simEps_40p_3.pth')
