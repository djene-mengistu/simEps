...
from upernet_base import BaseModel
from upernet_utils import initialize_weights
...
class ResNet(nn.Module):
    def __init__(self, in_channels=3, output_stride=16, backbone='resnet18', pretrained=False):
...
class UperNet(BaseModel):
    ...
    def __init__(self, num_classes, in_channels=3, backbone='resnet18', pretrained=False, use_aux=True, fpn_out=256, freeze_bn=False, **_):
...
def get_upernet(num_classes=4, in_channels=3, backbone='resnet18', pretrained=False, use_aux=True, fpn_out=64, freeze_bn=False, **kwargs):
#     acronyms = {
...
#     from ..data.dataloader import datasets
    model = UperNet(num_classes=num_classes, in_channels=in_channels, backbone=backbone, pretrained=pretrained, use_aux=True, fpn_out=fpn_out, freeze_bn=False, **kwargs)
#     if pretrained:
