...
class Network(object):
    ...
    def run(self):
        ...
        self.logger.info(
            "train_loader {} val_loader {} ".format(len(train_loader),
                                                    len(val_loader)))
        ...
        for epoch in range(1, epochs):
            ...
            train_data_dataloader = iter(cycle(train_loader))
            ...
            for iteration in range (1, iter_per_epoch):
                ...
                data = next(train_data_dataloader)
            ...
            if self.save_best_model_1:
                ...
                torch.save(state_1, Checkpoints_Path + '/baseline_40p.pth')
